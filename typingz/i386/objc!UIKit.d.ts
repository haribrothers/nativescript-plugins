...
declare class UIActivityIndicatorView extends UIView implements NSCoding {
	...
	setAnimatingWithStateOfTask(task: NSURLSessionTask): void;
...
declare class UIButton extends UIControl implements NSCoding {
	...
	static setSharedImageDownloader(imageDownloader: AFImageDownloader): void;

	static sharedImageDownloader(): AFImageDownloader;
	...
	cancelBackgroundImageDownloadTaskForState(state: UIControlState): void;

	cancelImageDownloadTaskForState(state: UIControlState): void;
	...
	setBackgroundImageForStateWithURL(state: UIControlState, url: NSURL): void;

	setBackgroundImageForStateWithURLPlaceholderImage(state: UIControlState, url: NSURL, placeholderImage: UIImage): void;

	setBackgroundImageForStateWithURLRequestPlaceholderImageSuccessFailure(state: UIControlState, urlRequest: NSURLRequest, placeholderImage: UIImage, success: (p1: NSURLRequest, p2: NSHTTPURLResponse, p3: UIImage) => void, failure: (p1: NSURLRequest, p2: NSHTTPURLResponse, p3: NSError) => void): void;

	setImageForState(image: UIImage, state: UIControlState): void;

	setImageForStateWithURL(state: UIControlState, url: NSURL): void;

	setImageForStateWithURLPlaceholderImage(state: UIControlState, url: NSURL, placeholderImage: UIImage): void;

	setImageForStateWithURLRequestPlaceholderImageSuccessFailure(state: UIControlState, urlRequest: NSURLRequest, placeholderImage: UIImage, success: (p1: NSURLRequest, p2: NSHTTPURLResponse, p3: UIImage) => void, failure: (p1: NSURLRequest, p2: NSHTTPURLResponse, p3: NSError) => void): void;
...
declare class UIImage extends NSObject implements NSSecureCoding, UIAccessibilityIdentification {
	...
	static safeImageWithData(data: NSData): UIImage;
...
declare class UIImageView extends UIView {
	...
	setImageWithURLPlaceholderImage(url: NSURL, placeholderImage: UIImage): void;

	setImageWithURLRequestPlaceholderImageSuccessFailure(urlRequest: NSURLRequest, placeholderImage: UIImage, success: (p1: NSURLRequest, p2: NSHTTPURLResponse, p3: UIImage) => void, failure: (p1: NSURLRequest, p2: NSHTTPURLResponse, p3: NSError) => void): void;
...
declare class UIProgressView extends UIView implements NSCoding {
	...
	setProgressWithDownloadProgressOfTaskAnimated(task: NSURLSessionDownloadTask, animated: boolean): void;

	setProgressWithUploadProgressOfTaskAnimated(task: NSURLSessionUploadTask, animated: boolean): void;
}
...
declare class UIRefreshControl extends UIControl {
	...
	setRefreshingWithStateOfTask(task: NSURLSessionTask): void;
}
...
declare class UIWebView extends UIView implements NSCoding, UIScrollViewDelegate {
	...
	loadRequestMIMETypeTextEncodingNameProgressSuccessFailure(request: NSURLRequest, MIMEType: string, textEncodingName: string, progress: interop.Pointer | interop.Reference<NSProgress>, success: (p1: NSHTTPURLResponse, p2: NSData) => NSData, failure: (p1: NSError) => void): void;

	loadRequestProgressSuccessFailure(request: NSURLRequest, progress: interop.Pointer | interop.Reference<NSProgress>, success: (p1: NSHTTPURLResponse, p2: string) => string, failure: (p1: NSError) => void): void;
